        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-300 text-sm">
              Your adventure partner for unforgettable treks, trips, and experiences across incredible destinations.
            </p>
            <div className="flex space-x-4">
              ...
              <a href="https://instagram.com" className="text-gray-300 hover:text-white transition-colors">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.62 5.367 11.987 11.988 11.987s11.987-5.367 11.987-11.987C24.014 5.367 18.647.001 12.017.001zM8.449 16.988c-1.297 0-2.448-.49-3.337-1.288C3.595 14.347 3.018 12.4 3.018 10.395c0-2.43.577-4.377 1.716-5.784.888-.797 2.04-1.287 3.337-1.287 1.297 0 2.448.49 3.337 1.287 1.139 1.407 1.716 3.354 1.716 5.784 0 2.005-.577 3.952-1.716 5.305-.889.798-2.04 1.288-3.337 1.288zM12 15.816c-3.132 0-5.671-2.539-5.671-5.671S8.868 4.474 12 4.474s5.671 2.539 5.671 5.671-2.539 5.671-5.671 5.671z"/>
                </svg>
              </a>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-gray-300">
              <p>📧 info@safarnama.com</p>
              <p>📞 +91 98765 43210</p>
              <p>📍 Mumbai, Maharashtra</p>
              <p>📱 @safarnama_adventures</p>
            </div>
          </div>
        </div>
